...
Submit.addEventListener(
  ...
  (calgp = () => {
    ...
    gpa = (sumProductOfCourseUnitAndCourseGrade / CourseUnit).toFixed(2);
    cal.classList.add("Dshow");
    Submit.classList.add("Dshow");

    score.innerHTML = `Dear ${UserName}, with matric number ${UserReg}, level ${UserLevel} in the ${UserDep} department, your GPA is ${gpa}.`;
  })
);
